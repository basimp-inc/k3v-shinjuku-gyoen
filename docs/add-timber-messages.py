#!/usr/bin/env python3
"""Add (or refresh) the "timber" namespace in messages/{ja,en,zh}.json.

Review-only: the namespace feeds the Timber Indigo design, the fourth entry of
...
they are part of the visual identity, exactly as the "gyoen" and "denim"
namespaces do it.
"""
...
# Identical in all three locales: they are set as display type, not as copy.
DISPLAY = {
    "hero": {"titleA": "Not Just", "titleThin": "A", "titleB": "Stay.", "titleEm": "Live Tokyo Beautifully."},
    "ticker": {"w1": "Wood", "w2": "Denim", "w3": "Forest", "w4": "Shadow", "em": "Cheap Chic Tokyo"},
    "concept": {"titleA": "Wood, Denim", "titleB": "& A Park", "titleEm": "next door."},
    "rooms": {
        "titleA": "Three Rooms.", "titleEm": "Three ways to live here.",
        "r1NameA": "Natural", "r1NameB": "Living",
        "r2NameA": "Urban", "r2NameB": "Vintage",
        "r3NameA": "Industrial", "r3NameB": "Modern",
    },
    "exp": {"titleA": "Step out.", "titleEm": "The city is the lobby.",
            "c1": "Gyoen", "c2": "Yokocho", "c3": "Kissa", "c4": "Skyline"},
    "material": {
        "titleA": "Four Materials.", "titleEm": "One house.",
        "m1": "Denim", "m1Em": "indigo, worn", "m1Hex": "#1B3A57",
        "m2": "Wood", "m2Em": "solid, warm", "m2Hex": "#6B4A32",
        "m3": "Forest", "m3Em": "the garden", "m3Hex": "#1F3A2E",
        "m4": "Shadow", "m4Em": "and light", "m4Hex": "#2B2620",
    },
    "location": {"titleA": "Two minutes", "titleEm": "from the gate.", "pin": "K3V — Here"},
    "cta": {"titleA": "Stay in the", "titleB": "heart of Tokyo.", "titleEm": "Live it beautifully."},
    "footer": {"brand": "K3V SHINJUKU GYOEN"},
}


def merged(locale_data):
    """Fold the shared display strings into a locale's tree."""
    out = collections.OrderedDict()
    for section, values in locale_data.items():
        merged_section = collections.OrderedDict(values)
        merged_section.update(DISPLAY.get(section, {}))
...
JA = {
    "nav": {
        "stay": "ステイ", "rooms": "お部屋", "experience": "まちあるき",
        "material": "素材", "location": "立地", "access": "アクセス",
        "book": "空室を見る", "menu": "メニュー",
    },
    "hero": {
        "eyebrow": "全3室 — 新宿御苑前、東京",
        "lead": "木とデニム、そして御苑の緑。\n新宿のど真ん中で、暮らすように過ごす3室。",
        "ctaPrimary": "公式サイトで予約", "ctaSecondary": "お部屋を見る",
        "edge": "Est. 2026 — Shinjuku, Tokyo",
        "vertical": "新宿御苑のすぐそばで、東京を暮らすように。",
        "plateLab": "3室 / 3ブランド",
        "p1": "unico", "p1Sub": "Natural Living",
        "p2": "Journal Standard Furniture", "p2Sub": "Urban Vintage",
        "p3": "Crash Gate", "p3Sub": "Industrial Modern",
    },
    "facts": {
        "f1n": "03", "f1l": "室のみ",
        "f2n": "3 min", "f2l": "新宿御苑まで",
        "f3n": "8 min", "f3l": "新宿駅まで",
        "f4n": "4 名", "f4l": "1室あたり最大",
        "scroll": "Scroll",
    },
    "ticker": {},
    "concept": {
        "idx": "コンセプト", "kicker": "新宿で、ちがう泊まり方を",
        "jp1": "新宿三丁目の喧騒を二本入ると、急に空気がゆるむ。K3V SHINJUKU GYOEN は、そんな路地に建つ全3室の小さな家です。",
        "jp2": "床は無垢の木、ソファにはデニム。窓の外には御苑の樹々。ホテルの整った気持ちよさではなく、「この部屋に住んでみたい」と思う気持ちよさを目指しました。",
        "en": "A three-room house between the noise of Shinjuku and the quiet of the garden. Solid timber, indigo denim, warm shadow — built to be lived in, not checked into.",
        "phLabel": "Living / Room 01", "smLabel": "Shinjuku Gyoen",
        "capLab": "Material No.01", "capBody": "座ると少し沈む、履き込んだデニムみたいなソファ。",
        "m1Note": "#1B3A57 — Fabric", "m2Note": "#6B4A32 — Structure",
        "m3Note": "#1F3A2E — Garden", "m4Note": "#2B2620 — Depth",
    },
    "rooms": {
        "idx": "お部屋",
        "note": "家具ブランドごとに世界観を変えた全3室。\n同じ建物なのに、泊まるたび違う暮らしが始まります。",
        "sizeLab": "広さ", "guestsLab": "定員", "bedLab": "ベッド", "floorLab": "階", "openLab": "オープン",
        "open": "販売中", "soon": "準備中",
        "r1Tag": "unico", "r1Em": "やわらかい北欧",
        "r1Body": "木の質感とファブリックの温度。朝の光がいちばん長く入る部屋です。ベッドの脇には小さなワークデスク。",
        "r1Size": "32㎡", "r1Guests": "2–4名", "r1Bed": "ダブル + ソファ", "r1Floor": "2F",
        "r1Link": "Room 01 を見る", "r1PhLabel": "Room 01 / unico",
        "r2Tag": "journal standard furniture", "r2Em": "使い込んだ質感",
        "r2Body": "アイアンと古材、履き込んだデニムのソファ。夜がいちばん似合う部屋。灯りを落とすと、外の新宿がちょうどよく遠くなります。",
        "r2Size": "34㎡", "r2Guests": "2–4名", "r2Bed": "クイーン + ソファ", "r2Floor": "3F",
        "r2Link": "Room 02 を見る", "r2PhLabel": "Room 02 / journal standard furniture",
        ...
        "r3Link": "オープンを知らせる", "r3PhLabel": "Room 03 / crash gate — 準備中",
    },
    "exp": {
        "idx": "まちあるき",
        "note": "御苑の芝生、路地裏の喫茶店、深夜のうどん。\n玄関を出た瞬間から、滞在は始まっています。",
        "c1p": "徒歩3分。朝いちの芝生はほぼ貸切です。",
        "c2p": "新宿三丁目の路地。深夜1時でも灯りが残っている。",
        "c3p": "昭和から続く喫茶店が、まだ何軒も残っています。",
        "c4p": "電線と高層ビルと木。東京らしい風景がぜんぶある。",
        "s1": "新宿御苑 3分", "s2": "伊勢丹 9分", "s3": "ゴールデン街 12分",
        "s4": "思い出横丁 14分", "s5": "代々木公園 18分", "s6": "羽田 45分", "s7": "成田 90分",
    },
    "material": {
        "idx": "素材",
        "note": "この建物は、たった4つの素材でできています。手で触れられるものだけで、世界観をつくりました。",
        "m1Lab": "Material 01", "m2Lab": "Material 02", "m3Lab": "Material 03", "m4Lab": "Material 04",
    ...
    "footer": {
        ...
        "copyright": "© 2026 K3V Shinjuku Gyoen", "credit": "Wood × Denim × Forest × Shadow",
    },
}

EN = {
    "nav": {
        "stay": "Stay", "rooms": "Rooms", "experience": "Experience",
        "material": "Material", "location": "Location", "access": "Access",
        "book": "Book Now", "menu": "Menu",
    },
    "hero": {
        "eyebrow": "03 Rooms — Shinjuku Gyoenmae, Tokyo",
        "lead": "Timber, denim and the green of the garden.\nThree rooms to live in, right in the middle of Shinjuku.",
        "ctaPrimary": "Book Direct", "ctaSecondary": "See The Rooms",
        "edge": "Est. 2026 — Shinjuku, Tokyo",
        "vertical": "新宿御苑のすぐそばで、東京を暮らすように。",
        "plateLab": "Three Rooms / Three Brands",
        "p1": "unico", "p1Sub": "Natural Living",
        "p2": "Journal Standard Furniture", "p2Sub": "Urban Vintage",
        "p3": "Crash Gate", "p3Sub": "Industrial Modern",
    },
    "facts": {
        ...
        "f2n": "3 min", "f2l": "To Shinjuku Gyoen",
        "f3n": "8 min", "f3l": "To Shinjuku Station",
        "f4n": "4 pax", "f4l": "Max Per Room",
        "scroll": "Scroll",
    },
    "ticker": {},
    "concept": {
        "idx": "Concept", "kicker": "Stay Different in Shinjuku",
        "jp1": "Two streets off the noise of Shinjuku 3-chome the air suddenly loosens. K3V SHINJUKU GYOEN is a small three-room house on exactly that kind of lane.",
        "jp2": "Solid timber underfoot, denim on the sofa, the trees of the garden through the window. Not the tidy comfort of a hotel — the comfort of a room you'd want to move into.",
        "en": "A three-room house between the noise of Shinjuku and the quiet of the garden. Solid timber, indigo denim, warm shadow — built to be lived in, not checked into.",
        "phLabel": "Living / Room 01", "smLabel": "Shinjuku Gyoen",
        "capLab": "Material No.01", "capBody": "A sofa that gives a little when you sit — like a well-worn pair of jeans.",
        "m1Note": "#1B3A57 — Fabric", "m2Note": "#6B4A32 — Structure",
        "m3Note": "#1F3A2E — Garden", "m4Note": "#2B2620 — Depth",
    },
    "rooms": {
        "idx": "Rooms",
        "note": "Three rooms, each built around one furniture brand.\nSame building — a different way of living every time you stay.",
        ...
        "r1Body": "The texture of wood and the warmth of fabric. Morning light stays in this room the longest. A small work desk sits beside the bed.",
        "r1Size": "32 m²", "r1Guests": "2–4", "r1Bed": "Double + Sofa", "r1Floor": "2F",
        "r1Link": "View Room 01", "r1PhLabel": "Room 01 / unico",
        "r2Tag": "journal standard furniture", "r2Em": "worn-in texture",
        "r2Body": "Iron, reclaimed timber and a denim sofa you've broken in. This room is at its best at night — dim the lights and Shinjuku moves comfortably far away.",
        "r2Size": "34 m²", "r2Guests": "2–4", "r2Bed": "Queen + Sofa", "r2Floor": "3F",
        "r2Link": "View Room 02", "r2PhLabel": "Room 02 / journal standard furniture",
        ...
        "r3Link": "Get Notified", "r3PhLabel": "Room 03 / crash gate — in preparation",
    },
    "exp": {
        "idx": "Experience",
        "note": "Lawns in the garden, a back-street coffee house, udon at midnight.\nThe stay starts the moment you step out the door.",
        "c1p": "Three minutes on foot. First thing in the morning the lawn is almost yours.",
        "c2p": "The lanes of Shinjuku 3-chome. Lights still on at 1am.",
        "c3p": "Coffee houses that have been running since the Showa era — several still here.",
        "c4p": "Power lines, towers and trees. Every Tokyo view at once.",
        "s1": "Shinjuku Gyoen 3min", "s2": "Isetan 9min", "s3": "Golden Gai 12min",
        "s4": "Omoide Yokocho 14min", "s5": "Yoyogi Park 18min", "s6": "Haneda 45min", "s7": "Narita 90min",
    },
    "material": {
        "idx": "Material",
...
ZH = {
    "nav": {
        "stay": "住宿", "rooms": "客房", "experience": "街区",
        "material": "材质", "location": "位置", "access": "交通",
        "book": "查看空房", "menu": "菜单",
    },
    "hero": {
    ...
    "ticker": {},
    "concept": {
        "idx": "概念", "kicker": "在新宿，换一种住法",
        "jp1": "从新宿三丁目的喧嚣往里走两条街，空气忽然松了下来。K3V SHINJUKU GYOEN 就是这样一条小巷里、只有3间客房的小房子。",
        "jp2": "地板是实木，沙发是丹宁，窗外是御苑的树。我们想要的不是酒店那种整齐的舒适，而是让人想「住进来看看」的舒适。",
        "en": "A three-room house between the noise of Shinjuku and the quiet of the garden. Solid timber, indigo denim, warm shadow — built to be lived in, not checked into.",
        "phLabel": "Living / Room 01", "smLabel": "Shinjuku Gyoen",
        "capLab": "Material No.01", "capBody": "坐下去会微微下陷，像一条穿旧了的牛仔裤。",
        "m1Note": "#1B3A57 — Fabric", "m2Note": "#6B4A32 — Structure",
        "m3Note": "#1F3A2E — Garden", "m4Note": "#2B2620 — Depth",
    },
    "rooms": {
        "idx": "客房",
        "note": "每间客房都以一个家具品牌构成不同的世界观。\n同一栋建筑，每次入住都是另一种生活。",
        "sizeLab": "面积", "guestsLab": "人数", "bedLab": "床型", "floorLab": "楼层", "openLab": "开业",
        "open": "现已开放", "soon": "即将开放",
        "r1Tag": "unico", "r1Em": "柔和北欧",
        "r1Body": "木的质感与织物的温度。晨光停留最久的房间，床边还有一张小书桌。",
        "r1Size": "32㎡", "r1Guests": "2–4人", "r1Bed": "双人床 + 沙发", "r1Floor": "2F",
        "r1Link": "查看 Room 01", "r1PhLabel": "Room 01 / unico",
        "r2Tag": "journal standard furniture", "r2Em": "用旧的质感",
        "r2Body": "铁艺、旧木与穿旧了的丹宁沙发。最适合夜晚的房间——把灯调暗，窗外的新宿就恰好远了一些。",
        "r2Size": "34㎡", "r2Guests": "2–4人", "r2Bed": "大床 + 沙发", "r2Floor": "3F",
        "r2Link": "查看 Room 02", "r2PhLabel": "Room 02 / journal standard furniture",
        "r3Tag": "crash gate", "r3Em": "筹备中",
        "r3Body": "以铁与实木的对比构成的第三间。目前正在施工，是三间里最硬朗的一间，开放时间将另行公布。",
        "r3Size": "待定", "r3Guests": "待定", "r3Open": "2026年 —",
        "r3Link": "开放时通知我", "r3PhLabel": "Room 03 / crash gate — 筹备中",
    },
    "exp": {
        "idx": "街区",
        "note": "御苑的草坪、巷子里的咖啡店、深夜的乌冬面。\n走出门的那一刻，旅程就已经开始。",
        "c1p": "步行3分钟。清晨的草坪几乎属于你一个人。",
        "c2p": "新宿三丁目的小巷。凌晨一点仍有灯亮着。",
        "c3p": "从昭和年代经营至今的咖啡店，这一带还留着好几家。",
        "c4p": "电线、高楼和树。东京该有的风景全都在。",
        "s1": "新宿御苑 3分钟", "s2": "伊势丹 9分钟", "s3": "黄金街 12分钟",
        "s4": "回忆横丁 14分钟", "s5": "代代木公园 18分钟", "s6": "羽田 45分钟", "s7": "成田 90分钟",
    },
    "material": {
        "idx": "材质",
...
for name, data in (("ja", JA), ("en", EN), ("zh", ZH)):
    ...
    print(f"messages/{name}.json  timber namespace: {len(ref)} keys")
