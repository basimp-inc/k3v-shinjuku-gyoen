  ...
  return (
    <header className='sticky top-0 z-50 w-full bg-[#f3ece1]/85 backdrop-blur-md'>
      <div className='mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-3 md:px-10 md:py-4'>
        <a href='#top' className='font-en text-xl font-semibold tracking-wide text-[#4a3a24] md:text-2xl'>
          K3V
        </a>
        ...
        <div className='flex shrink-0 items-center gap-2 md:gap-3'>
          <LocaleSwitcher />
          <a href='#stay' className='group hidden items-center gap-2 rounded-full bg-[#8a6b45] px-5 py-2.5 text-sm text-[#faf6ee] transition-all duration-200 hover:bg-[#745936] hover:scale-[1.03] lg:inline-flex'>
            {t("cta")}
